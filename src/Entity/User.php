...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\ManyToMany(targetEntity: Mealplan::class, inversedBy: 'users')]
    ...
    public function addMeal(Mealplan $meal): static
    {
    ...
    public function removeMeal(Mealplan $meal): static
    {
